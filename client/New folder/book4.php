		...
		{	$N = count($seats_selected);
			...
			{	//echo"<br>Making Ticket.";
				...
				{	echo "<br><b>Error in making ticket";
					echo'<a href= "book2.php">back</a>';
				}
			}
			else
			{	echo "<br>Number of seats requested and no of seats selected dont match";
				echo'<br><a href= "book2.php">back</a>';
			}
		}
		echo '<br><a href="./1910.html">Home</a>';
		echo'<br><a href="./css_useraccount.php">Your Account</a>';
		exit();
	}
?>